...
public class BusStoryDTO{
	...
	public List<String> placelat;
	public List<String> placelng;
	public List<String> lmNames;
	...
	public BusStoryDTO(String ref, String buslat, String busLong) {
		...
		placelat = new ArrayList<String>();
		placelng = new ArrayList<String>();
		lmNames = new ArrayList<String>();
	...
	public void addLandmarks(Landmark landmark) {
		placelat.add(landmark.latitude.toString());
		placelng.add(landmark.longitude.toString());
		lmNames.add(landmark.name);
	}

	public void addStories(String stories) {
		story.add(stories);
	}
